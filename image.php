...
<?php the_post() ?>
			<div id="post-<?php the_ID() ?>" <?php post_class(); ?>>
				<h3 class="entry-title"><a href="<?php echo get_permalink($post->post_parent) ?>" title="<?php printf( __( 'Return to %s', 'satorii' ), esc_html( get_the_title($post->post_parent), 1 ) ) ?>" rev="attachment"><?php echo get_the_title($post->post_parent) ?></a> &gt; <?php the_title() ?></h3>
...
<?php the_content() ?>
				...
				<div class="entry-meta">
					<?php printf( __( 'Posted by %1$s on <abbr class="published" title="%2$sT%3$s">%4$s at %5$s</abbr>. Bookmark the <a href="%6$s" title="Permalink to %7$s" rel="bookmark">permalink</a>. Follow any comments here with the <a href="%8$s" title="Comments RSS to %7$s" rel="alternate" type="application/rss+xml">RSS feed for this post</a>.', 'satorii' ),
...
<?php endif; ?>
<?php edit_post_link( __( 'Edit', 'satorii' ), "\n\t\t\t\t\t<span class=\"edit-link\">", "</span>" ) ?>
				</div>
			</div><!-- .post -->
